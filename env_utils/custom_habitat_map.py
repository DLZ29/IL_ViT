...
node= [np.array([-5.2530847 ,  0.17282087,  3.2406325 ]), np.array([-4.728492  ,  0.17282087,  2.1110723 ]), np.array([-3.4607134 ,  0.17282087,  0.24437541]), np.array([-2.9403458 ,  0.17282087, -3.171939  ]), np.array([-0.58548284,  0.17282087, -3.8160808 ]), np.array([ 0.1626797 ,  0.17282087, -2.5970502 ]), np.array([-1.8089252 ,  0.17282087, -3.8833482 ]), np.array([-2.8343298 ,  0.17282087, -4.9498324 ])]
