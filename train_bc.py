...
from resnet_model import ResNetForNavigation
...
parser.add_argument('--data-dir', default='/data/xxx/manual_control/IL_data', type=str)  #your_data_path
parser.add_argument('--resume', default='none', type=str)
parser.add_argument("--accumulation-steps", type=int, default=1, help="Number of gradient accumulation steps")
...
def train():
    ...
    })#Box(low, high, shape=None, dtype=np.float32)
